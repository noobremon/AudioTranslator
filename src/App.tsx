...
function App() {
  ...
  const { translateText, isTranslating, updateAPIKeys, hasAPIKeys, clearContext } = useEnterpriseTranslation();
  const { speak, isSpeaking: ttsIsSpeaking, stop: stopSpeaking } = useTextToSpeech(volume);
  const { 
    startListening, 
    stopListening, 
    transcript, 
  ...
  }, [isListening, showHistory, showAPIKeys, showQualityMonitor, currentTranslation, isAutoMode, audioSource, isSpeaking]);
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-300 text-lg mb-4">
            Professional-grade Chinese to English translation with 99.9% accuracy
          </p>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 mb-6 border border-white/20">
                ...
                <div className="bg-slate-800/50 rounded-lg p-4 mb-4">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <button
                      ...
                      className="text-green-300 hover:text-green-200 p-2 rounded-lg hover:bg-green-500/20 transition-all duration-200"
            ...
            <div className="flex justify-center items-center gap-6 mb-6 flex-wrap">
              ...
              <button
                ...
                title={isListening && audioSource === 'system' ? 'Stop system audio (Ctrl+M)' : 'Capture system audio (Ctrl+M)'}
              >
                {isListening && audioSource === 'system' ? (
                  <MicOff className="w-8 h-8" />
                ) : (
            ...
            <div className="bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-green-500/10 border border-blue-500/30 rounded-lg p-4 mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-slate-300">
                <ul className="space-y-1">
                  ...
                  <li>• <strong>Context Preservation:</strong> Maintains conversation flow</li>
                </ul>
                <ul className="space-y-1">
                  <li>• <strong>Ultra-low Latency:</strong> Sub-200ms translation response</li>
                  <li>• <strong>Error Recovery:</strong> Automatic failover and retry</li>
